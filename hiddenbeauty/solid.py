...
from hiddenbeauty.utils import rotate, scale, translate, get_fast_bbox, make_3d, center_around_origin, save_mesh, flip_mesh
from hiddenbeauty.extrude import simple_extrude
import subprocess
...
#        save_mesh("modified", outer_box);
    ...
    if not opts['no_url']:
        print("make url")
        url = make_text_mesh("hiddenbeauty.ch", True)
